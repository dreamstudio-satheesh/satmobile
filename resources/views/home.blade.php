<html lang="en">
  <head>
    ...
    <meta name="description" content="SAT - Multipurpose Ecommerce Mobile HTML Template">
    ...
    <!-- Title -->
    <title>SAT - Multipurpose Ecommerce Mobile HTML Template</title>
  ...
  <body>
    ...
    <div class="toast pwa-install-alert shadow bg-white" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="5000" data-bs-autohide="true">
      <div class="toast-body">
        ...
        </div><span class="mb-0 d-block">Add SAT on your mobile home screen. Click the<strong class="mx-1">Add to Home Screen</strong>button &amp; enjoy it like a regular app.</span>
      </div>
    </div>
